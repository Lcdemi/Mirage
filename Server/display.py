...
def choose_targets():
    groups = [
        # Format: (config_key, display_label, list_of_hosts)
        ("ALL_HOSTS", "All Hosts", CONFIG.hosts.ALL_HOSTS),
        ("ALL_WINDOWS", "Windows: All Hosts", CONFIG.hosts.ALL_WINDOWS),
        ("ALL_WINDOWS_CA", "Windows: Certificate Authorities", CONFIG.hosts.ALL_WINDOWS_CA),
        ("ALL_WINDOWS_DC", "Windows: Domain Controllers", CONFIG.hosts.ALL_WINDOWS_DC),
        ("ALL_WINDOWS_FTP", "Windows: FTP Hosts", CONFIG.hosts.ALL_WINDOWS_FTP),
        ("ALL_WINDOWS_ICMP", "Windows: ICMP Hosts", CONFIG.hosts.ALL_WINDOWS_ICMP),
        ("ALL_WINDOWS_IIS", "Windows: IIS Hosts", CONFIG.hosts.ALL_WINDOWS_IIS),
        ("ALL_WINDOWS_MSSQL", "Windows: MSSQL Hosts", CONFIG.hosts.ALL_WINDOWS_MSSQL),
        ("ALL_WINDOWS_RDP", "Windows: RDP Hosts", CONFIG.hosts.ALL_WINDOWS_RDP),
        ("ALL_WINDOWS_SMB", "Windows: SMB Hosts", CONFIG.hosts.ALL_WINDOWS_SMB),
        ("ALL_WINDOWS_SSH", "Windows: SSH Hosts", CONFIG.hosts.ALL_WINDOWS_SSH),
        ("ALL_WINDOWS_WINRM", "Windows: WinRM Hosts", CONFIG.hosts.ALL_WINDOWS_WINRM),
        ("ALL_LINUX", "Linux: All Hosts", CONFIG.hosts.ALL_LINUX),
        ("ALL_LINUX_APACHE", "Linux: Apache Hosts", CONFIG.hosts.ALL_LINUX_APACHE),
        ("ALL_LINUX_DOCKER", "Linux: Docker Hosts", CONFIG.hosts.ALL_LINUX_DOCKER),
        ("ALL_LINUX_FTP", "Linux: FTP Hosts", CONFIG.hosts.ALL_LINUX_FTP),
        ("ALL_LINUX_ICMP", "Linux: ICMP Hosts", CONFIG.hosts.ALL_LINUX_ICMP),
        ("ALL_LINUX_MONGO", "Linux: Mongo Hosts", CONFIG.hosts.ALL_LINUX_MONGO),
        ("ALL_LINUX_MYSQL", "Linux: MySQL Hosts", CONFIG.hosts.ALL_LINUX_MYSQL),
        ("ALL_LINUX_NGINX", "Linux: NGINX Hosts", CONFIG.hosts.ALL_LINUX_NGINX),
        ("ALL_LINUX_POSTGRESQL", "Linux: PostgreSQL Hosts", CONFIG.hosts.ALL_LINUX_POSTGRESQL),
        ("ALL_LINUX_SAMBA", "Linux: Samba Hosts", CONFIG.hosts.ALL_LINUX_SAMBA),
        ("ALL_LINUX_SSH", "Linux: SSH Hosts", CONFIG.hosts.ALL_LINUX_SSH),
        ("ALL_FREEBSD", "FreeBSD: All Hosts", CONFIG.hosts.ALL_FREEBSD),
        ("ALL_ROUTER", "FreeBSD: Router Hosts", CONFIG.hosts.ALL_ROUTER),
    ]
    ...
    mapping = {
        ...
        "ALL_WINDOWS": CONFIG.hosts.ALL_WINDOWS,
        "ALL_WINDOWS_CA": CONFIG.hosts.ALL_WINDOWS_CA,
        "ALL_WINDOWS_DC": CONFIG.hosts.ALL_WINDOWS_DC,
        "ALL_WINDOWS_FTP": CONFIG.hosts.ALL_WINDOWS_FTP,
        "ALL_WINDOWS_ICMP": CONFIG.hosts.ALL_WINDOWS_ICMP,
        "ALL_WINDOWS_IIS": CONFIG.hosts.ALL_WINDOWS_IIS,
        "ALL_WINDOWS_MSSQL": CONFIG.hosts.ALL_WINDOWS_MSSQL,
        "ALL_WINDOWS_RDP": CONFIG.hosts.ALL_WINDOWS_RDP,
        "ALL_WINDOWS_SMB": CONFIG.hosts.ALL_WINDOWS_SMB,
        "ALL_WINDOWS_SSH": CONFIG.hosts.ALL_WINDOWS_SSH,
        "ALL_WINDOWS_WINRM": CONFIG.hosts.ALL_WINDOWS_WINRM,
        "ALL_LINUX": CONFIG.hosts.ALL_LINUX,
        "ALL_LINUX_APACHE": CONFIG.hosts.ALL_LINUX_APACHE,
        "ALL_LINUX_DOCKER": CONFIG.hosts.ALL_LINUX_DOCKER,
        "ALL_LINUX_FTP": CONFIG.hosts.ALL_LINUX_FTP,
        "ALL_LINUX_ICMP": CONFIG.hosts.ALL_LINUX_ICMP,
        "ALL_LINUX_MONGO": CONFIG.hosts.ALL_LINUX_MONGO,
        "ALL_LINUX_MYSQL": CONFIG.hosts.ALL_LINUX_MYSQL,
        "ALL_LINUX_NGINX": CONFIG.hosts.ALL_LINUX_NGINX,
        "ALL_LINUX_POSTGRESQL": CONFIG.hosts.ALL_LINUX_POSTGRESQL,
        "ALL_LINUX_SAMBA": CONFIG.hosts.ALL_LINUX_SAMBA,
        "ALL_LINUX_SSH": CONFIG.hosts.ALL_LINUX_SSH,
        "ALL_FREEBSD": CONFIG.hosts.ALL_FREEBSD,
        "ALL_ROUTER": CONFIG.hosts.ALL_ROUTER,
    }
